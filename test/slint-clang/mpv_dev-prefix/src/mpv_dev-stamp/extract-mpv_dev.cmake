...
#
get_filename_component(filename "C:/Users/admin/Documents/GitHub/ImPlay-clang/mpv-dev-x86_64-20260503-git-948c86d24c.7z" ABSOLUTE)
get_filename_component(directory "C:/Users/admin/Documents/GitHub/ImPlay-clang/out/build/slint-clang/mpv_dev-prefix/src/mpv_dev" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-mpv_dev${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-mpv_dev${i}")
